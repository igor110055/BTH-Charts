...
if chart == 'Order Flow' and timeframe == '5min':
    ...
    try:
      ...
      fig.update_xaxes(showspikes=True, spikethickness=0.1, spikemode='across', spikecolor="grey", spikesnap='cursor', spikedash='dot')
      fig.update_yaxes(showspikes=True, spikethickness=0.1, spikemode='across', spikecolor="grey", spikesnap='cursor', spikedash='dot')
